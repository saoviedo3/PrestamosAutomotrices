...
public class VendedorController {
    ...
    @GetMapping
    @JsonView(Vendedor.Views.Public.class)
    ...
    @PostMapping
    @JsonView(Vendedor.Views.Public.class)
    public ResponseEntity<Vendedor> createVendedor(
            @Validated(Vendedor.CreateValidation.class) @RequestBody Vendedor vendedor) {
        try {
    ...
    public ResponseEntity<Vendedor> updateVendedor(
            ...
            @Validated(Vendedor.UpdateValidation.class) @RequestBody Vendedor vendedor) {
        try {
