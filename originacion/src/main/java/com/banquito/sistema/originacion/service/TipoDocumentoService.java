...
public class TipoDocumentoService {
    ...
    public TipoDocumento actualizar(Integer id, TipoDocumento tipoDocumentoActualizado) {
        try {
            ...
            throw new BusinessException("Error al actualizar tipo de documento: " + e.getMessage(),
    ...
    public void eliminar(Integer id) {
        try {
            ...
            throw new BusinessException("Error al eliminar tipo de documento: " + e.getMessage(),
    ...
    public void crearTiposPredeterminados() {
        try {
            ...
            throw new BusinessException("Error al crear tipos predeterminados: " + e.getMessage(),
                    "CREAR_TIPOS_PREDETERMINADOS");
        }
    }
